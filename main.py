...
def main():
    ...
    # Array to store individual objects
    objects = []
    temp_obj_pos = None
    ...
    while running:
        ...
        # Draw background; needs to happen first before placing objects
        win.blit(BG, (0, 0))
        ...
        for obj in objects[:]:
            obj.draw()
            obj.move(planet)
            # Remove objects once off the screen so CPU doesn't get bottlenecked
            off_screen = obj.x < 0 or obj.x > WIDTH or obj.y < 0 or obj.y > HEIGHT
            # Planet point collision
